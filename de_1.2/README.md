# Data Engineering Zoomcamp - 1.2
## Pipeline using Python (pandas), Postgres and Docker

In this class, we made a simple pipeline extracting data the NY Taxi files
([TLC Trip Record Data](https://www.nyc.gov/site/tlc/about/tlc-trip-record-data.page))
with a Python script ingesting the data in Postgres Tables using docker. \

In the end, we delivered an ingestion data Docker Image
[url2pg](https://github.com/bouli/url2pg) we can use for
other projects and the working pipline in a [docker compose file](docker-compose.yaml).
Deliverables:
- [url2pg](https://github.com/bouli/url2pg): This repository ingests data from a CSV/Parquet url into a Postgres table;
- [docker-compose.yaml](docker-compose.yaml): Docker compose file that enables the pipeline;
...
> [snippets/pandas-convert_parquet_to_csv.md](../snippets/pandas-convert_parquet_to_csv.md)
```python
import pandas as pd
import sys
...
> [ingestion-data.py](https://github.com/bouli/url2pg/blob/main/ingestion-data.py)
```python
import pandas as pd
...
Let's update our [Dockerfile](https://github.com/bouli/url2pg/blob/main/Dockerfile) to install the our script dependencies:

> [Dockerfile](https://github.com/bouli/url2pg/blob/main/Dockerfile)
```Dockerfile
FROM python:3.9
...
Github Repository: [https://github.com/bouli/url2pg](https://github.com/bouli/url2pg)
